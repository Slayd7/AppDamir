...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2267968185984931716, ; hash 0x1f79710c8784d784, from name: libaot-AppDamir.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 52
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4374780419108813114, ; hash 0x3cb6579cd350b93a, from name: aot-AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	...
	%struct.DSOCacheEntry {
		i64 11131320026989042511, ; hash 0x9a7a649699df9b4f, from name: AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 274
	...
	%struct.DSOCacheEntry {
		i64 11765458096786221473, ; hash 0xa3474dcd8eafa9a1, from name: libaot-AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 298
	...
	%struct.DSOCacheEntry {
		i64 12416772270929820572, ; hash 0xac513c97f1b13b9c, from name: AppDamir.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 319
	...
	%struct.DSOCacheEntry {
		i64 15061715830739048172, ; hash 0xd105f6bf671416ec, from name: aot-AppDamir.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
...
@.env.3 = private unnamed_addr constant [37 x i8] c"3873009f-6f00-45bc-b3b9-a667188a4bec\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.appdamir\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-AppDamir.dll.so\00", align 16
