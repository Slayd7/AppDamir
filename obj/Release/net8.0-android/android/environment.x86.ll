...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 483547392, ; hash 0x1cd25900, from name: libaot-AppDamir.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1147122808, ; hash 0x445fb478, from name: AppDamir.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 1622875890, ; hash 0x60bb1ef2, from name: AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	...
	%struct.DSOCacheEntry {
		i64 1924639507, ; hash 0x72b7ab13, from name: aot-AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 2539664613, ; hash 0x976034e5, from name: aot-AppDamir.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 282
	...
	%struct.DSOCacheEntry {
		i64 4000590601, ; hash 0xee742b09, from name: libaot-AppDamir
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppDamir.dll.so
		ptr null; void* handle (0x0)
	}, ; 449
